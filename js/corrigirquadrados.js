...
var left = ($(window).width() /2);
  ...
  //console.log ("altura tela:"+ top * 2+" largura tela:"+left * 2);
...
var larguravideo = alturavideo*2 * 1.777;
  ...
  //console.log ("altura video:"+ alturavideo * 2+" largura video:"+larguravideo);
}
...
var alturavideo = larguravideo*2/1.777;
 // console.log ("altura video:"+ alturavideo+" largura video:"+larguravideo);
}
...
console.log ("barraleft= "+barraleft );
var barratop = 30;
...
var posy = 
((((top*2)-(alturavideo))/2)+(alturavideo*232/446));
...
/*  if (left/top > 1,777)
  {
    var tamx = 162/762* 2 * top * 1,777;
    var tamy = 149/432 * 2* top;
$('#selec2').hide();


console.log("top= " + top + ", left= " + left+ "tamy= "+ tamy+ "tamx= ", tamx);
}*/




//$(window).resize(COPIAR FUNCAO DE CIMA);
